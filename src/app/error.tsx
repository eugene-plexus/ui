...
export default function ErrorPage({
  ...
  return (
    <main className="flex h-screen items-center justify-center p-6">
      <div className="w-full max-w-lg rounded-md border border-[color:var(--border)] bg-[color:var(--panel)] p-6">
        ...
        <div className="flex gap-2">
          <button
            type="button"
            onClick={reset}
            className="font-ui rounded bg-[color:var(--accent-left)] px-4 py-2 text-sm font-medium text-[color:var(--on-accent-left)] transition-[filter] hover:brightness-110"
          >
            Try again
          </button>
          <button
            ...
            className="font-ui rounded border border-[color:var(--border)] px-4 py-2 text-sm transition-colors hover:border-[color:var(--border-hover)] hover:bg-[color:var(--panel-hover)]"
          >
            Reload page
          </button>
        </div>
